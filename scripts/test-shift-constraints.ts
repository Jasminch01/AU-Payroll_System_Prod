...
async function runTests() {
    ...
    // 3. Create a PAST shift (Started 10 minutes ago, ends in 50 minutes)
    const pastStart = new Date(today.getTime() - 10 * 60 * 1000);
    const pastEnd = new Date(today.getTime() + 50 * 60 * 1000);
    ...
    console.log(`✅ Created shift that started 10m ago: ${pastShiftId}`);
