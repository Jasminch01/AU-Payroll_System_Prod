...
import { UserPlus, Users, Send, RefreshCw, Copy, Check, MoreHorizontal, Eye, ExternalLink, Trash2, Filter, X, Briefcase, User, ShieldCheck, ChevronRight, AlertTriangle, Shield, Lock, CreditCard, ChevronDown, Info, Plus } from "lucide-react";
        ...
        >
            <DataTable
                ...
                actions={
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button className="fixed bottom-24 right-6 h-14 w-14 lg:h-9 lg:w-auto p-0 lg:px-4 lg:py-2 gap-2 shadow-2xl shadow-[hsl(var(--brand))]/40 lg:shadow-md hover:shadow-lg transition-all lg:ml-2 rounded-full lg:rounded-lg z-50 lg:static">
