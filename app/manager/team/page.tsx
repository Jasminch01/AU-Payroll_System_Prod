            ...
            render: (row) => (
                <div className="flex gap-2 justify-end">
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        onClick={(e) => { e.stopPropagation(); router.push(`/manager/team/${row.employee_id}`); }}
                    >
                ...
                <DialogContent>
                    ...
                    <div className="space-y-4 py-2">
                        ...
                        <div className="flex gap-2">
                            <button
                                type="button"
                                className="flex-1 rounded-lg border border-[hsl(var(--brand))] bg-[hsl(var(--brand-light))] px-4 py-2.5 text-sm font-medium text-[hsl(var(--brand))]"
                            >
                                Employee (Default)
                            </button>
                        </div>
